...
export default function LayoutEmp() {
    ...
    <>
      <div className="min-h-screen flex">
        ...
        <div className="h-full gap-2 w-full">
          <div className="h-full bg-default flex justify-between px-4 py-2">
          ...
          <div className="flex flex-col w-full px-8 py-4 justify-between h-full">
            <Outlet />
          </div>
        </div>
      </div>
